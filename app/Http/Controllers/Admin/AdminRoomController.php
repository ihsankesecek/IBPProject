...
class AdminRoomController extends Controller
{
    ...
    public function edit($id){
       ...
       return view('admin.room_edit',compact('room_data','amenities','existing_amenities'));
    }
    ...
    public function room_photos($id){
        $photos = RoomPhoto::get()->where('room_id',$id);
        return view('admin.r_p_view', compact('photos'));
        echo $photos->room_id;
    }

    public function photo_add(){
        return view('admin.room_gallery_photos');
    }
