...
class CustomerLoginController extends Controller
{
    ...
    public function signup_store(Request $request){
        ...
        $reset_link = url('signup/verify/' .$request->email. '/'.$token);
    ...
    public function signup_verify($email,$token){
        ...
        return redirect()->route('customer_login')->with('success','Your verification is OK!');

        }else{
        return redirect()->route('home')->with('success','Your verification is OK!');
    ...
    public function reset_password_submit(Request $request){
        ...
        return redirect()->route("customer_login")->with("success","Password has been updated successfully");
